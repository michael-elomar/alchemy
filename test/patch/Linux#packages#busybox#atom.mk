...
# Patches
BUSYBOX_PATCHES := \
	lucie/busybox-1.14.0-gzip.patch \
	lucie/busybox-1.14.0-libbb.patch \
	lucie/busybox-1.14.0-notrace.patch \
	lucie/busybox-1.14.0-unaligned.patch
...
ifneq ("$(wildcard $(TARGET_CONFIG_DIR)/busybox.config)","")
  ...
  BUSYBOX_CONFIG_FILE := $(LOCAL_PATH)/lucie/busybox.config
endif
