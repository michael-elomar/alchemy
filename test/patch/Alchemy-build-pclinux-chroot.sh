...
export TARGET_OS_FLAVOUR="native-chroot"
export TARGET_LIBC="native"
export TARGET_ARCH="x86"
export TARGET_CPU=""
export TARGET_OUT="${TOP_DIR}/Alchemy-out/${TARGET_PRODUCT}-${TARGET_PRODUCT_VARIANT}-chroot"
...
export TARGET_SKEL="${TOP_DIR}/Alchemy/test/native-chroot-skel"
