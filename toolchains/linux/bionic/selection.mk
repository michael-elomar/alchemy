...
ANDROID_TOOLCHAIN_TOKEN_SUFFIX := $(subst $(space),$(empty),$(ANDROID_TOOLCHAIN_SCRIPT) $(ANDROID_TOOLCHAIN_OPTIONS))
ANDROID_TOOLCHAIN_TOKEN_SUFFIX := $(subst /,$(empty),$(ANDROID_TOOLCHAIN_TOKEN_SUFFIX))
