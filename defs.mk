...
is-module-in-make-goals = $(strip \
	$(call is-targets-in-make-goals,$1 $1-clean $1-dirclean $1-path $1-codecheck $1-doc))
...
$(Q)$(CCACHE) $(PRIVATE_CXX) \
	...
	$(TARGET_GLOBAL_CXXFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(TARGET_GLOBAL_CFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(WARNINGS_CXXFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
...
$(Q)$(CCACHE) $(PRIVATE_CXX) \
	...
	$(TARGET_GLOBAL_CFLAGS_$(PRIVATE_ARCH)_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(PRIVATE_CFLAGS) $(PRIVATE_CXXFLAGS) \
...
$(Q)$(CCACHE) $(PRIVATE_CC) \
	...
	$(TARGET_GLOBAL_CFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(WARNINGS_CFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(TARGET_GLOBAL_CFLAGS_$(PRIVATE_ARCH)) \
	$(TARGET_GLOBAL_CFLAGS_$(PRIVATE_ARCH)_$(PRIVATE_COMPIL_FLAVOUR)) \
	$(PRIVATE_CFLAGS) \
	-c -MMD -MP -MF $(@:.o=.d) -MT $@ -o $@ \
...
$(Q)$(PRIVATE_CXX) \
	...
	$(TARGET_GLOBAL_LDFLAGS_$(PRIVATE_COMPIL_FLAVOUR)) \
