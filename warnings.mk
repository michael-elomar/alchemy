...
ifneq (0,$(shell expr $(TARGET_GCC_VERSION) \>= 4.0.0))
...
ifneq (0,$(shell expr $(TARGET_GCC_VERSION) \>= 4.5.0))
#COMMON_FLAGS_WARNINGS += -Wunreachable-code
endif

# gcc >= 4.5.2
ifneq (0,$(shell expr $(TARGET_GCC_VERSION) \>= 4.5.2))
...
# gcc >= 4.4.0
ifneq (0,$(shell expr $(TARGET_GCC_VERSION) \>= 4.4.0))
