...
# Call custom macros.
# It verifies that it really exists first
...
# Note: you can add $(info xx$(__tmp)xx) before the last eval to debug what is
# internally generated by the macro call.
$(foreach __entry,$(LOCAL_CUSTOM_MACROS), \
	...
	$(if $(call is-var-undefined,$(__w1)), \
		$(warning $(LOCAL_PATH): module '$(LOCAL_MODULE)' uses undefined custom macro '$(__w1)'), \
