...
vars-TARGET += GLOBAL_CFLAGS_arm_clang
vars-TARGET += GLOBAL_CFLAGS_thumb
vars-TARGET += GLOBAL_CFLAGS_thumb_gcc
vars-TARGET += GLOBAL_CFLAGS_thumb_clang
...
vars-TARGET_SETUP += GLOBAL_CFLAGS_arm_clang
vars-TARGET_SETUP += GLOBAL_CFLAGS_thumb
vars-TARGET_SETUP += GLOBAL_CFLAGS_thumb_gcc
vars-TARGET_SETUP += GLOBAL_CFLAGS_thumb_clang
