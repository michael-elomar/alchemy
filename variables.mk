...
# Meson customization
vars-LOCAL += MESON_CONFIGURE_ENV
vars-LOCAL += MESON_CONFIGURE_ARGS
vars-LOCAL += MESON_BUILD_ENV
vars-LOCAL += MESON_BUILD_ARGS
vars-LOCAL += MESON_INSTALL_ENV
vars-LOCAL += MESON_INSTALL_ARGS

# CMake customization
vars-LOCAL += CMAKE_CONFIGURE_ENV
vars-LOCAL += CMAKE_CONFIGURE_ARGS
vars-LOCAL += CMAKE_MAKE_BUILD_ENV
vars-LOCAL += CMAKE_MAKE_BUILD_ARGS
vars-LOCAL += CMAKE_MAKE_INSTALL_ENV
...
vars-TARGET += IMAGE_VERITY_FORMAT_PARAMS
vars-TARGET += IMAGE_VERITY_OPTIONS
...
vars-TARGET += SDK_ALLOW_OLDER_CC
vars-TARGET += SDK_ALLOW_NEWER_CC
vars-TARGET += SDK_OPTIONAL_CROSS
vars-TARGET += FINAL_PYTHON_GENERATE_PYC
vars-TARGET += FINAL_PYTHON_REMOVE_PY
...
# Qt
vars-TARGET += QMAKE
vars-TARGET += QT_VERSION
vars-TARGET += QT_PLATFORM
...
vars-TARGET_SETUP += PREFER_STATIC
vars-TARGET_SETUP += NO_UNDEFINED
vars-TARGET_SETUP += YOCTO_SDK
vars-TARGET_SETUP += YOCTO_VERSION
vars-TARGET_SETUP += TOOLCHAIN_TRIPLET
vars-TARGET_SETUP += PKG_CONFIG_PATH
